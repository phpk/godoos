<template>
    <my-card :getData="getCopyFromMeList" :filterDate="dateRange" :showAction="true" :showFilter="true"
        :columns="columns" :showPagination="true" @reset="resetDate">
        <template #filter>
