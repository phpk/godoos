<template>
	<div class="file-explorer-container">
		<div class="command-bar">
			...
			<div
				class="path"
				v-show="pathState == 'pendding'"
				@click="startInput"
			>
				<span
					class="path-p"
					v-for="(p, index) in routePaths"
					:key="index"
					@click.stop="handlePathClick(index)"
				>
					{{ p }}
					<el-icon>
						<ArrowRight />
		...
		<div class="main-content no-select">
				...
				<div class="navigation-pane">
					<div class="quick-access-section">
						<div
							...
							@click="quickAccessShow = !quickAccessShow"
						>
							<el-icon
								v-if="quickAccessShow"
								class="header-icon"
			...
			<div class="file-list-area">
				<desktop-icons
					:isDesktop="false"
					:fileList="fileList"
					:showClass="viewMode === 'grid' ? 'file-grid' : 'file-list'"
					@navigateTo="navigateTo"
		...
		<SaveFile
			v-if="fileSystemStore.choose.ifShow"
			:winId="winId"
			:currentPath="currentPath"
		/>
	</div>
