...
// import { BrowserWindowConstructorOptions } from "@/type/browserWindow";
...
export type BrowserWindowContent = ReturnType<typeof defineComponent> | Function | string;
...
class BrowserWindow {
  ...
  show() {
    if (!this.windowInfo.isCreated) {
      const rootState = useSystem()._rootState;
      //console.log(rootState.windowOrder)
      //console.log(this)
