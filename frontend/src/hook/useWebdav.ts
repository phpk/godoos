// import { System, dirname, extname } from '@/system';
// import { FileStat, createClient } from 'webdav';
// //import WebdavSetVue from '@/views/apps/WebdavSet.vue';
...
//   }
// }
  //   system.mountVolume(localStorage.getItem('webdav_path') || '/F', {
  //     async readdir(path:any) {
  ...
  //       if (
  //         ['.mp4', '.mkv', '.mp3', '.png', '.jpg', '.jpeg', '.gif', '.bmp', '.webp', '.svg'].includes(ext)
  //       ) {
